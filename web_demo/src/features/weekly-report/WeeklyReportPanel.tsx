...
export function WeeklyReportPanel() {
  ...
  const chartOption = {
    ...
    tooltip: {
      ...
      borderColor: 'rgba(126, 173, 248, 0.42)',
      textStyle: { color: '#eaf2ff' },
    },
    xAxis: {
      type: 'category',
      data: scenario.weekly.map((item) => item.day),
      axisLine: { lineStyle: { color: 'rgba(130, 165, 222, 0.62)' } },
      axisLabel: { color: '#dce8ff' },
    },
    yAxis: [
      {
        type: 'value',
        ...
        min: 0,
        max: 10,
        nameTextStyle: { color: '#a9c2e9' },
        axisLabel: { color: '#dce8ff' },
        splitLine: { lineStyle: { color: 'rgba(154, 176, 219, 0.24)' } },
      },
      {
        type: 'value',
        name: '步数',
    ...
    series: [
      {
        ...
        lineStyle: { color: '#ff7f7d', width: 3 },
        itemStyle: { color: '#ff7f7d' },
        areaStyle: { color: 'rgba(255, 127, 125, 0.24)' },
      },
      {
        name: '步数',
        type: 'bar',
        ...
        itemStyle: { color: '#38c7b4', borderRadius: [6, 6, 0, 0] },
        barWidth: 18,
      },
    ],
  };
